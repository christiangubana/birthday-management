    ...
    <div class="p-4">
      <div class="grid gap-14 md:grid-cols-3 md:gap-5">
        <div class="rounded-xl bg-white p-6 text-center shadow-xl">
          ...
          <h1 class="text-gray-500 mb-3 text-xl font-medium lg:px-14">
            DESCRIPTION
          </h1>
          <p class="px-4 text-gray-500">
            A simple application that allows capturing the first name and ID
            number of team members, and then be able to see a list of birthdays
            in the next 7 days 👉
          </p>
        </div>
        <div
        ...
        >
          ...
          <p class="px-4 text-gray-500">
            You don't have to add an actual birthdate as this can be calculated
            from the ID number. You also should not need to take any manual
            steps to see the team members birthday show up next year as well.
          </p>
        </div>
        <div
          data-aos-delay="300"
        ...
        >
          ...
          <img
            className="mx-auto max-w-full h-auto max-md:max-w-[80%] md:max-w-[50%] lg:max-w-[40%] xl:max-w-[30%] object-cover"
            src={image}
            alt="Illustration 01"
          />
        </div>
