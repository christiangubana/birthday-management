    ...
    <>
      ...
      {isModalVisible && (
        <div
          ...
          tabIndex="-1"
          aria-hidden="true"
          className="fixed top-0 right-0 left-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-30"
        >
          <div className="relative p-4 w-full max-w-2xl max-h-full overflow-y-auto bg-white rounded-lg shadow dark:bg-gray-700">
